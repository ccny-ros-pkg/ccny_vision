"""autogenerated by genmsg_py from ARMarker.msg. Do not edit."""
...
class ARMarker(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','uint32','geometry_msgs/PoseWithCovariance','uint32']
